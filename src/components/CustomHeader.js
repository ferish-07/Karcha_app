...
export default function CustomHeader({navigation, screen, title, isEdit,deletePressed, isbackArror}) {
  if(screen == "dashboard"){
    ...
    return(
      <View style={{
        ...
        {isEdit ? <TouchableOpacity style={{ justifyContent:'center', alignItems:'center',  }}
